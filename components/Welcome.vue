    ...
    <div>
        <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
            ...
            <div class="mt-8 text-2xl">
                Welcome to Lists & Contacts application!
            </div>

            <div class="mt-6 text-gray-500">
                Lists & Contacts application allows you to add, edit and delete as many contacts as you wish all conveniently categorized in Lists.
                <br>
                We hope you love it.
            </div>
        </div>
            ...
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold">
                        <a href="https://laravel.com/docs">Our Documentation</a>
                    </div>
                </div>

                <div class="ml-12">
                    <div class="mt-2 text-sm text-gray-500">
                        Lists & Contacts has wonderful documentation covering every aspect you will need to use our service with speed & efficiency. Whether you're new to our service or have previous experience, we recommend reading all of the documentation from beginning to end.
                    </div>
            ...
            <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
                <div class="flex items-center">
                    <svg
                        ...
                        y="0px"
                        viewBox="0 0 598 148"
                        style="enable-background:new 0 0 598 148;"
                        xml:space="preserve"
                        class="w-1/4"
                    >
                        <linearGradient
                        ...
                        <path
                            class="st0"
                            d="M9.6,69.2L99.2,9.8c3.5-2.3,9.1-2.3,12.6,0l89.6,59.4c5.4,3.6,5.4,9.4,0,12.9l-12,7.9
      ...
      C123.2,123.5,114.9,118.2,105.5,118.2z"
                        ...
                        <path
                            class="st1"
                            d="M261.1,75.3l22.5,32.3h-15.8l-17-25c0,8.2,0,16.8,0,25H238V43.8h12.8c0,8.5,0,17,0,25.5l16.1-25.5h14.9
      ...
      s-20.6,9.2-20.6,20.6s9.2,20.6,20.6,20.6S579.3,85.9,579.3,74.6z"
                ...
                <div class="ml-12">
                    <div class="mt-2 text-sm text-gray-500">
                        Klaviyo is an automated marketing platform created to provide ecommerce businesses integration solutions, APIs and strategies for their technology systems.
                        Our service provides integration with Klaviyo.
                    </div>

                    <NuxtLink :to="{ name: 'ManageKlaviyoIntegration' }">
                        <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                            <div>Manage your Klaviyo API Keys</div>
